...
11e. For computer-agent style desktop control from any device, use computer_action on the laptop: see/ocr to read visible screen text, click_label to click a labeled control, mouse move/click/drag/scroll, type, keys, and window list/activate/move. Prefer computer_action when the user wants something clicked, typed, or visible on the desktop; verify with see before claiming success.
