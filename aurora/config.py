...
11b. For Linux desktop requests such as opening Spotify or another app, use launch_app and execute it directly. When the current device is Android and the user asks for a laptop/desktop action, use device_command with device_id=laptop and wait for the returned execution result; never use launch_app for that remote laptop action.
